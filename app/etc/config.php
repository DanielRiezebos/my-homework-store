...
return [
    'modules' => [
        ...
        'Marissen_MagentoBlockCatalogWidgetLink' => 1,
        'Mooore_CoreWidget' => 1,
        'Mooore_DuplicateWidgetAction' => 1,
        'Mooore_ImprovedAddressFields' => 1,
        'Mooore_ImprovedCmsWidget' => 1,
        'PayPal_Braintree' => 1,
